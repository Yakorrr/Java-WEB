...
<div class="lang-bar">
    <div class="lang-bar-images">
        <a href="/admin-users?lang=ua">
            <img src="templates/img/ua-01.png" alt="ua">
        </a>
        <a href="/admin-users?lang=en">
...
<div class="main-wrapper">
    <h3 class="m-4"><%=Localization.getString("u-all-users")%>
    </h3>
    ...
    <table class="table admin-table">
        ...
        <tr>
            ...
            <td>
                <a href="/admin-users?method=remove&id=<%=user.getId()%>">
                    <%=Localization.getString("u-del")%>
                </a></td>
            <td>
                <a href="/admin-users?method=privilege_a&id=<%=user.getId()%>">
                    <%=Localization.getString("u-to-a")%>
                </a> |
                <a href="/admin-users?method=privilege_u&id=<%=user.getId()%>">
    ...
    <h3 class="m-4"><%=Localization.getString("u-add")%>
    </h3>
