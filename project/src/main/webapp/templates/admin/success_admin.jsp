...
<div class="lang-bar">
    <div class="lang-bar-images">
        <a href="<c:url value="/admin?lang=ua"/>">
            <img src="templates/img/ua-01.png" alt="ua">
        </a>
        <a href="<c:url value="/admin?lang=en"/>">
...
<div class="wrapper-custom">
    ...
    <table class="table table-formatting m-4">
        ...
        <tr>
            ...
            <td>
                <a href="<c:url value="/approve?method=approve&id=<%=req.getId()%>"/>">
        ...
        <ul class="pagination">
            <% Integer pageCount = (Integer) request.getAttribute("page-count");
                ...
                for (int i = 1; i <= pageCount; i++) {
                    if (i == active) {%>
            <li class="page-item active"><a class="page-link" href="<c:url value="/admin?page=<%=i%>"/>"><%=i%>
            </a></li>
            <%} else {%>
            <li class="page-item"><a class="page-link" href="<c:url value="/admin?page=<%=i%>"/>"><%=i%>
            </a></li>
            <%
                    }
                }
