...
<table class="table">
    ...
    <tr>
        ...
        <th scope="col"><%=Localization.getString("user-req-table-start-date")%></th>
        <th scope="col"><%=Localization.getString("user-req-table-end-date")%></th>
        <th scope="col"><%=Localization.getString("user-req-table-app")%></th>
        <th scope="col"><%=Localization.getString("user-req-table-cancel")%></th>
    ...
    <%  List<Request> requests = (List<Request>) request.getAttribute("entries");
        for(Request r : requests) {%>
                <tr>
                    ...
                    <td><%=r.isApproved()%></td>
                    <td>
                        <a href="/user-my-requests?method=cancel&id=<%=r.getId()%>"><%=Localization.getString("user-req-table-cancel")%></a></td>
                    <td>
                        <% if (r.isApproved()) {
