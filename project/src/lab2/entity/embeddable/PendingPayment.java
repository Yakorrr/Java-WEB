package lab2.entity.embeddable;

import lab2.entity.CompletedPayment;
...
public class PendingPayment {
    ...
    @Pattern(regexp = "^([0-9]{4} ?){3}[0-9]{4}", message = "16 digit number expected")
    @NotNull
    ...
    // This is the format, it doesn't tell spring how to convert from this format back into a date
