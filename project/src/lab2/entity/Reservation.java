...
import lab2.entity.embeddable.ReservationDates;
...
public class Reservation {
    ...
    /**
     * Allows UI to easily remove a {@code Guest} in the 'add guest' page. It's easier for the UI to 'POST' a guest id
    ...
    public void setGeneralExtras(Set<Extra> generalExtras) throws IllegalArgumentException {
        ...
        if (generalExtras.stream()
                .anyMatch(extra -> extra.getCategory() != Extra.Category.General)) {
     ...
     * Provided separately to allow break down to subtotals on invoices.
     *
    ...
    /**
     * Total cost including everything! (excluding tax)
     * Provided separately to allow break down to subtotals on invoices.
     */
